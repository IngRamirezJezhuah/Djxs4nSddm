/*
Las condifuraciones de otros sddm se rompian cuando los descargaba
asi que me canse y decidi hacer el mio, tome partes de los componentes
con la licencia GPLv3 + licencia, para que no digan que lo saque del culo
ademas casi no hay nada en español asi que cuenta mi grano de arena

=====================================================
    Importaciones de librerias de QML 5 y 6
======================================================
NOTA: hay algunas que son despreciadas oh no funcionan si no las tienes
te recomiendo descargarlas adjuntare en el readme las dependencias
segun las distribucion por que casi nadie las actualiza
*/
import QtQuick 2.15
...
Pane {
    ...
    Item {
        ...
        FastBlur {
            ...
            radius: config.BlurMax == "" ? 48 : parseInt(config.BlurMax)
            visible: config.FullBlur == "true" || config.PartialBlur == "true" ? true : false
        }
    }
}